...
public class DriverManager {
    ...
    private static DesiredCapabilities getCaps(String deviceID){
        ...
        DesiredCapabilities caps = new DesiredCapabilities();
            ...
            caps.setCapability("app", "/Users/apple/Desktop/HolidayIQ/HolidayIQ/src/main/resources/HolidayIQ.apk");
            return caps;
    }
    ...
    private static URL host(String deviceID) throws MalformedURLException {
        if(hosts == null){
            hosts = new HashMap<>();
            //hosts.put("192.168.1.7:5555", new URL("http://127.0.0.1:4723/wd/hub"));
            hosts.put("21026425", new URL("http://127.0.0.1:4723/wd/hub"));
